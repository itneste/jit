...
import { ExpenseBillRoutingModule } from './routing';
...
import { FilesComponent } from './components/files-component/filescomponent';
...
@NgModule({
    ...
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjfront/expensebill/'},
        FinishLoadService,
...
export class ExpenseBillModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjfront/expensebill/i18n/', '.json');
}