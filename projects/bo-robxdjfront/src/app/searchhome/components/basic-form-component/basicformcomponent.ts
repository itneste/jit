...
export class BasicFormComponent extends FrameComponent implements OnInit, AfterViewInit {
    ...
    emp_55c1353b_j313_PlaceHolder = this.langService.transform('TextBox/emp_55c1353b_j313/placeHolder', this.lang, "");
    org_cea34aac_fage_PlaceHolder = this.langService.transform('TextBox/org_cea34aac_fage/placeHolder', this.lang, "");
}