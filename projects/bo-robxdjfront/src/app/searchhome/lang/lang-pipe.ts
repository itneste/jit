...
export function createTranslateLoader(http: HttpClient,version:string) {
  ...
  return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjfront/searchhome/i18n/', '.json'+ versionSuffix);
}

export const lang = {"zh-CHS":{"root-component":"","root-layout":"","page-header":"","header-nav":"","header-title-container":"","page-header-title":"查询索引页","page-header-toolbar":"","button-search":"查询","button-cancel":"取消","button-close":"关闭","main-container":"","card-container":"","basic-form-component-ref":"","basic-form-component":"","basic-form-layout":"","emp_55c1353b_j313":"报销人","TextBox/emp_55c1353b_j313/placeHolder":"","org_cea34aac_fage":"所属组织","TextBox/org_cea34aac_fage/placeHolder":""}};
    ...
    if (langCode == "zh-CHS" || (this.translate.defaultLang === langCode && this.translate.currentLoader == createTranslateLoader(this.http,null))) {
      ...
      const httpOb = this.http.get("/apps/fssp/fssc/web/bo-robxdjfront/version.json?v=" + new Date().getTime()).pipe(switchMap((data)=>{
        ...
        if (data instanceof Array) {
          const versionKey = "searchhome/" + langCode + ".json";
          data.forEach((item) => {
