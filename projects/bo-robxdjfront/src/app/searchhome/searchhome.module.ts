...
import { searchHomeRoutingModule } from './routing';
...
@NgModule({
    ...
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjfront/searchhome/'},
        FinishLoadService,
...
export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjfront/searchhome/i18n/', '.json');
}