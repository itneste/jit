...
import { searchHomequeryResultRoutingModule } from './routing';
...
@NgModule({
    ...
    imports: [
        ...
        searchHomequeryResultRoutingModule,
    ],
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjfront/searchhomequeryresult/'},
        FinishLoadService,
...
export class searchHomequeryResultModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjfront/searchhomequeryresult/i18n/', '.json');
}