...
export function createTranslateLoader(http: HttpClient,version:string) {
  ...
  return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjfront/baoxiaodanchaxun/i18n/', '.json'+ versionSuffix);
}

export const lang = {"zh-CHS":{"root-component":"","root-layout":"","query-scheme-card":"","basic-form-component-ref":"","button-layout":"","button-query":"查询","qdp-framework-component":"报销单据查询","spreadSheet1":"","basic-form-component":"","basic-form-section":"","Section/basic-form-section/mainTitle":"","Section/basic-form-section/subTitle":"","basic-form-layout":"","emp_b682dcb2_dhm7":"报销人","TextBox/emp_b682dcb2_dhm7/placeHolder":"","org_0067feb1_nkog":"所属组织","TextBox/org_0067feb1_nkog/placeHolder":""}};
    ...
    if (langCode == "zh-CHS" || (this.translate.defaultLang === langCode && this.translate.currentLoader == createTranslateLoader(this.http,null))) {
      ...
      const httpOb = this.http.get("/apps/fssp/fssc/web/bo-robxdjfront/version.json?v=" + new Date().getTime()).pipe(switchMap((data)=>{
        ...
        if (data instanceof Array) {
          const versionKey = "baoxiaodanchaxun/" + langCode + ".json";
          data.forEach((item) => {
