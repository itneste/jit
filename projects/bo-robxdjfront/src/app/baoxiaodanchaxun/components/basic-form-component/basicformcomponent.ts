...
import { BaoxiaodanchaxunFrmRepository } from '../../models/baoxiaodanchaxunfrmrepository';
...
import { LoadAndAdd2Handler } from '../../viewmodels/handlers/loadandadd2handler';
...
@Component({
    ...
    providers: [
        ...
        { provide: Repository, useExisting: BaoxiaodanchaxunFrmRepository },
        LangService,
        ...
        { provide: COMMAND_HANDLERS_TOKEN, useClass: LoadAndAdd2Handler, multi: true },
]
})
export class BasicFormComponent extends FrameComponent implements OnInit, AfterViewInit {
    ...
    public onFormLoad() {
        this.viewModel.LoadAndAdd2(); 
    } 
    tabsToolbarStates = new BehaviorSubject({});
    tabsToolbarVisibleStates = new BehaviorSubject({});
    SectionbasicformsectionMainTitle = this.langService.transform('Section/basic-form-section/mainTitle', this.lang, "");
    SectionbasicformsectionSubTitle = this.langService.transform('Section/basic-form-section/subTitle', this.lang, "");
    emp_b682dcb2_dhm7_PlaceHolder = this.langService.transform('TextBox/emp_b682dcb2_dhm7/placeHolder', this.lang, "");
    org_0067feb1_nkog_PlaceHolder = this.langService.transform('TextBox/org_0067feb1_nkog/placeHolder', this.lang, "");
}