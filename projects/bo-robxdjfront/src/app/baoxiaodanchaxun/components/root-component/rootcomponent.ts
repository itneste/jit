...
import { BaoxiaodanchaxunFrmProxy } from '../../models/baoxiaodanchaxunfrmproxy';
...
@Component({
    ...
    providers: [
        ...
        UriService,
        BaoxiaodanchaxunFrmProxy,
        BaoxiaodanchaxunFrmRepository,
        ...
        { provide: FORM_ID, useValue: "79c8bcf0-d094-4b61-bc31-f14a7011235a" },
...
QdpFrameworkQueryNameqdpframeworkcomponent = this.langService.transform('qdp-framework-component', this.lang, "报销单据查询");
    Buttonbutton_query = this.langService.transform('button-query', this.lang, "查询");
}