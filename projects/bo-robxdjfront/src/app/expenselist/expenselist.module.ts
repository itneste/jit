...
import { ExpenseListRoutingModule } from './routing';
...
@NgModule({
    ...
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/fssp/fssc/web/bo-robxdjfront/expenselist/'},
        FinishLoadService,
...
export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/fssp/fssc/web/bo-robxdjfront/expenselist/i18n/', '.json');
}